...
//
// Run: WALLET-less (it deploys one). Needs slippay-deployer funded on testnet.
//   DEPLOYER_SECRET=$(stellar keys show slippay-deployer) NODE_PATH=apps/web/node_modules \
