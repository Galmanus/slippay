# SlipPay × Dune — 4 queries de subscription-intelligence
...
**Dashboard alvo:** `dune.com/slippay/subscription-intelligence`
...
-- subscription_charged do contrato SlipPay nos últimos 35 dias.
