...
SlipPay exposes one rail through two surfaces. They share the same non-custodial
...
- non-custodial settlement: in both narratives the buyer's or agent's wallet
  signs funds directly to the merchant; SlipPay never holds or signs for funds.
