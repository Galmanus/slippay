...
| **buyer subscription keys** | per-buyer; not slippay-side | out of scope — buyers manage their own |
...
| recommended for slippay v0.1 mainnet | **yes** | upgrade target for v0.2 | only if Ledger is unavailable |
