...
const COPY = {
  en: {
    nav: { live: "Live", pay: "Pay", receive: "Receive", pricing: "Pricing", manifesto: "Manifesto", login: "Login", tryFree: "Try it free" },
    hero: {
  ...
  pt: {
    nav: { live: "Ao vivo", pay: "Pagar", receive: "Receber", pricing: "Preços", manifesto: "Manifesto", login: "Entrar", tryFree: "Testar grátis" },
    hero: {
...
export default function LandingV2() {
  ...
  const t = COPY[lang];
  const NAV: [string, string][] = [[t.nav.live, "/cockpit"], [t.nav.pay, "/pay"], [t.nav.receive, "/cobrar"], [t.nav.pricing, "#pricing"], [t.nav.manifesto, "/manifesto"], [t.nav.login, "/account"]];
