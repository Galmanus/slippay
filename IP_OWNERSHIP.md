...
## Declaração de Autoria e Propriedade Intelectual — Slippay
...
- **Slippay payment architecture** — a PIX↔Stellar dollar-payments rail ("a dollar account that lives in Pix").
