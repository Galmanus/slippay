// SlipPay integrity oracle — chain-agnostic core.
//
...
// SlipPay earns from Base/EVM agent volume without porting the rail.
//
...
const DATA = process.env.SLIPPAY_ATTESTER_DATA || `${process.env.HOME || "."}/.slippay/surfaces.json`;
