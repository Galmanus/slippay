#!/usr/bin/env bash
# End-to-end demo of slippay-smart-wallet v0.1 on Stellar testnet.
#
...
#   slippay-deployer key has testnet funding
#
...
# Demo merchant + token (mirror of the slippay-subscription DEPLOYED.md
